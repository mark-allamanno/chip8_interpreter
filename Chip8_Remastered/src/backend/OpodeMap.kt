...
/*
    An interface for all opcodes to implement so they can be stored as a hash map in our backend.main backend.Chip8 emulation to
...
/*
    Below is the implementation of all of the opcode needed for the backend.Chip8 interpretation in class form.
...
/*
    ...
    to be abe to cleanly access them from the backend.Chip8 class itself. This is best abstracted by
...
class OpcodeMap constructor(instance: Chip8, display: Display): HashMap<String, Opcode>() {
    ...
    // The array of regex compliant strings to match against opcodes and the current backend.Chip8 instance
